...
import space.getsub.sync.GeoRefreshScheduler
import space.getsub.sync.RefreshScheduler
import java.io.File
...
class SubspaceApplication : Application(), Configuration.Provider {
     ...
     * production — [space.getsub.sync.GeoRefreshWorker]'s own `finally`. Without this
     ...
     * [space.getsub.sync.SubscriptionRefreshWorker]'s doWork() uses a `finally`: a crash
