...
import space.getsub.core.data.di.subspaceDatabase
import space.getsub.core.model.GeoDataKind
import space.getsub.core.model.GeoDataValidator
import space.getsub.core.model.GeoValidation
import java.io.File
...
class GeoAssetLockService : Service() {
    ...
    companion object {
        const val EXTRA_DATABASE_NAME = "space.getsub.core.data.geo.lock.database"
        const val EXTRA_ROOT = "space.getsub.core.data.geo.lock.root"
        const val EXTRA_READY_FILE = "space.getsub.core.data.geo.lock.ready"
        const val EXTRA_STARTED_FILE = "space.getsub.core.data.geo.lock.started"
        const val EXTRA_RESULT_FILE = "space.getsub.core.data.geo.lock.result"
        const val EXTRA_CLOSED_FILE = "space.getsub.core.data.geo.lock.closed"
