...
import space.getsub.core.data.db.ProfileDao
...
import space.getsub.core.data.serialization.toOutbound
...
public data class StoredProfile(
     ...
     *
     * VLESS only — [space.getsub.core.xray.XrayConfigGenerator] refuses the other
     ...
     * `xhttpSettings` from [space.getsub.core.model.StreamSettings.transport], and
...
/**
 * The `streamSettings.network` values [space.getsub.core.xray.XrayConfigGenerator]
...
internal constructor(
     ...
     *   ([space.getsub.feature.profiles.add.ImportViewModel]) reports this to the
     ...
     *
     * [reason] is a [space.getsub.core.parser.PassthroughRejection]'s `name`, not the
 ...
 * [space.getsub.core.model.StreamSettings] at all — they summarise as plain `tcp`.
 *
