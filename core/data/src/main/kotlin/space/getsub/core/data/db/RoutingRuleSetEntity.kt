...
internal data class RoutingRuleSetEntity(
    ...
    val blockIps: String,
    /** [space.getsub.core.model.RouteOutcome] names, comma-separated. */
    val routeOrder: String,
    /** A [space.getsub.core.model.DomainStrategy] name. */
     ...
     * [space.getsub.core.data.serialization.ProfileDnsCodec] in Happ's
