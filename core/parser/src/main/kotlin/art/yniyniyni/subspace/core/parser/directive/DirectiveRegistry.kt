...
public object DirectiveRegistry {
    public val specs: Map<String, DirectiveSpec> =
        listOf(
            ...
            accept("profile-title", DirectiveKind.Text(25, base64Allowed = true), Danger.Benign, Consumer.M4),
            accept("profile-update-interval", DirectiveKind.Integer(1, HOURS_IN_A_YEAR), Danger.Sensitive, Consumer.M4),
            accept("subscription-userinfo", DirectiveKind.Text(200, base64Allowed = false), Danger.Benign, Consumer.M4),
            accept("support-url", DirectiveKind.Url, Danger.Benign, Consumer.M9),
            accept("profile-web-page-url", DirectiveKind.Url, Danger.Benign, Consumer.M9),
            accept("announce", DirectiveKind.Text(200, base64Allowed = true), Danger.Benign, Consumer.M9),
            accept("routing-enable", DirectiveKind.Bool, Danger.Sensitive, Consumer.M6),
            reject(
            ...
            accept("serverdescription", DirectiveKind.Text(30, base64Allowed = true), Danger.Benign, Consumer.M9),
            accept(
                "sub-info-color",
            ...
            accept("sub-info-text", textNoBase64(200), Danger.Benign, Consumer.M9),
            accept("sub-info-button-text", textNoBase64(25), Danger.Benign, Consumer.M9),
            accept("sub-info-button-link", DirectiveKind.Url, Danger.Sensitive, Consumer.M9),
            accept("sub-expire", DirectiveKind.Bool, Danger.Benign, Consumer.M9),
            accept("sub-expire-button-link", DirectiveKind.Url, Danger.Sensitive, Consumer.M9),
            ...
            accept("notification-subs-expire", DirectiveKind.Bool, Danger.Benign, Consumer.M9),
            ...
            accept("subscription-autoconnect", DirectiveKind.Bool, Danger.Sensitive, Consumer.M9),
            accept(
            ...
            accept("subscription-ping-onopen-enabled", DirectiveKind.Bool, Danger.Sensitive, Consumer.M4_5),
            accept("subscription-auto-update-enable", DirectiveKind.Bool, Danger.Sensitive, Consumer.M4),
            accept("subscription-auto-update-open-enable", DirectiveKind.Bool, Danger.Sensitive, Consumer.M4),
            accept("change-user-agent", textNoBase64(256), Danger.Sensitive, Consumer.M4),
            accept("subscription-request-timeout", DirectiveKind.Integer(5, 15), Danger.Sensitive, Consumer.M4),
            reject("subscription-alternative-hwid-enabled", CUT_DESKTOP),
            accept("subscriptions-collapse", DirectiveKind.Bool, Danger.Benign, Consumer.M9),
            accept("subscriptions-expand-now", DirectiveKind.Bool, Danger.Benign, Consumer.M9),
            accept("subscription-pin", DirectiveKind.Bool, Danger.Benign, Consumer.M9),
            accept(
            ...
            accept("ping-result", DirectiveKind.Enumerated(setOf("time", "icon")), Danger.Benign, Consumer.M4_5),
            accept("dont-use-filter", DirectiveKind.Bool, Danger.Benign, Consumer.M9),
            accept("fragmentation-enable", DirectiveKind.Bool, Danger.Sensitive, Consumer.M8),
            accept("fragmentation-packets", DirectiveKind.Csv, Danger.Sensitive, Consumer.M8),
            accept("fragmentation-length", textNoBase64(32), Danger.Sensitive, Consumer.M8),
            accept("fragmentation-maxsplit", textNoBase64(32), Danger.Sensitive, Consumer.M8),
            ...
            accept("fragmentation-interval", textNoBase64(32), Danger.Sensitive, Consumer.M8),
            accept("noises-enable", DirectiveKind.Bool, Danger.Sensitive, Consumer.M8),
            accept(
                "noises-packet-type",
            ...
            accept("noises-packet", DirectiveKind.Csv, Danger.Sensitive, Consumer.M8),
            accept("noises-delay", DirectiveKind.Integer(0, 60_000), Danger.Sensitive, Consumer.M8),
            accept("noises-rand", textNoBase64(32), Danger.Sensitive, Consumer.M8),
            accept("noises-rand-range", textNoBase64(32), Danger.Sensitive, Consumer.M8),
            ...
            // brief's row table suggests Consumer.M4_5 here, reasoning that
            // `no Dangerous key is consumed in M4` only forbids Consumer.M4. But the
            ...
            accept("sniffing-enable", DirectiveKind.Bool, Danger.Sensitive, Consumer.M7),
            accept("xray-tun-enable", DirectiveKind.Bool, Danger.Sensitive, Consumer.M8),
            accept("xray-tun-mtu", DirectiveKind.Integer(68, 65_535), Danger.Sensitive, Consumer.M8),
            accept("inbound-http-enable", DirectiveKind.Bool, Danger.Sensitive, Consumer.M8),
            accept("dns-from-json-enable", DirectiveKind.Bool, Danger.Sensitive, Consumer.M8),
            reject("proxy-ping-mode", CUT_DESKTOP),
            accept("mux-enable", DirectiveKind.Bool, Danger.Sensitive, Consumer.M8),
            accept("mux-tcp-connections", DirectiveKind.Integer(-1, 1024), Danger.Sensitive, Consumer.M8),
            accept("mux-xudp-connections", DirectiveKind.Integer(-1, 1024), Danger.Sensitive, Consumer.M8),
            accept("mux-quic", textNoBase64(32), Danger.Sensitive, Consumer.M8),
            accept("app-auto-start", DirectiveKind.Bool, Danger.Sensitive, Consumer.M7),
            accept(
