 ...
 * same reason [space.getsub.feature.profiles.add.AddServerSheetContent] is (see that
 * file's own KDoc). No Hilt, [EditorViewModel] or [space.getsub.feature.profiles.ProfileSource]
 ...
 * [space.getsub.feature.profiles.add.AddServerSheetTest] documents; no
...
class EditorScreenTest {
     ...
     * space.getsub.feature.profiles.add.AddServerSheetSubscriptionTest] has one: v2's
