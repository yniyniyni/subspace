 ...
 *   [GroupCard][space.getsub.core.ui.component.GroupCard] update
 ...
 *   space.getsub.core.data.sync.SyncResult] entirely, so a refresh
 ...
 *   active search/filter — what [GroupCard][space.getsub.core.ui.component.GroupCard]'s
 ...
 *   [GroupCard][space.getsub.core.ui.component.GroupCard]'s
 ...
 * @property subscriptionId the id of the [space.getsub.core.data.StoredSubscription]
 *   that owns this group, or `null` for a `MANUAL` group. Fix round (code
 *   review, three Important findings): this is what lets
 *   [ServersGroupList][space.getsub.feature.profiles.list.ServersGroupList]
 ...
 *   [space.getsub.core.data.StoredSubscription.lastFetchedAt],
 ...
 * @property isActive whether this is the profile [space.getsub.core.data.SettingsRepository.activeProfileId]
 *   currently names.
...
internal data class ServerRow(
     ...
     * on [space.getsub.core.model.LatencyResult.outcome] before showing
